...
public class DateUtil {
    ...
    private final static String dateTimeFormat = "yyy-MM-dd HH:mm:ss";
	...
	* @author fh
	 ...
	 * @return
	 */
	public static Date formatDateAccurateToSecond(String date) {
	...
	public static String getDateAfterNDays(String dateTime, int days) {
		...
		try {
			time = sdfTime.parse(dateTime).getTime();
		} catch (ParseException e) {
			e.printStackTrace();
		}

		long newTime = time + (1000 * 60 * 60 * 24 * days);

		return sdfDay.format(new Date(newTime));
	}
    ...
    public static void main(String[] args) {
        System.out.println(timestampDay(("1565750799000")));
    }
